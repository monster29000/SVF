...
static llvm::cl::opt<bool> NPDCHECKER("npd", llvm::cl::init(false),
                                      llvm::cl::desc("NULL-Pointer-Dereference Detection"));
...
int main(int argc, char ** argv)
{
    ...
    if(NPDCHECKER)
    {
        NPDsaber = new NPDChecker();
        NPDsaber->runOnModule(svfModule);
    }
